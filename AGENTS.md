...
4. Key commands: `jui build` (distribute layouts + build), `jui verify` (spec vs layout check)
...
Every JsonUI project has `jui.config.json` at the project root, created by `jui init`.
