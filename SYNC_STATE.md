...
source_commit: e492e07e1af5264f57b01a87fd67201ac78a3889

- **Last sync date:** 2026-07-30
- **Source commit subject:** `docs(test agent): a mock that omits optional fields is under-specified, not wrong`role` key`
